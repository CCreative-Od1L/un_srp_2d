...
2. 打开 `Assets/Scenes/PlayerMovement.unity`
3. 运行场景，用 WASD 或手柄控制角色移动
4. 按住 Tab（键盘）或 L1（手柄）后用 Q/E 或 RT/LT 调整摄像机缩放

---

## 新增功能流程

1. 在 `Assets/Scenes/` 创建新场景
2. 在 `Assets/Scripts/Features/` 下新建功能文件夹
3. 在 `Core/Contracts/` 定义接口
4. 在 `Features/` 实现功能，在 `Infrastructure/DI/` 注册 VContainer 依赖
5. 更新 `PROJECT_REFERENCE.md` 的 Scene Index
